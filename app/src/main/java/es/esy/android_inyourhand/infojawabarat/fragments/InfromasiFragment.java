...
import es.esy.android_inyourhand.infojawabarat.adapters.ViewPagerInformasiAdapter;
...
public class InfromasiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_infromasi, container, false);
    ...
    private void setupToolbar(){
        toolbar.setTitle(getString(R.string.informasi_terbaru));
        toolbar.setSubtitle(getString(R.string.informasi_fragment_subtitle));
    ...
    private void setupViewPager(){
        viewPager.setAdapter(new ViewPagerInformasiAdapter(getActivity().getSupportFragmentManager()));
    }
